...
public class PetStoreTest extends ReadConfigUtility {
	...
	public void searchPetByID() {
		...
		expect().statusCode(200).and().when().get(baseEndpoint + "/api/v3/pet/{petId}", petId);
	}
	...
	public void deletePetByID() {
		expect().statusCode(200).and().when().delete(baseEndpoint + "/api/v3/pet/{petId}", petIdToDelete);
	}
}
